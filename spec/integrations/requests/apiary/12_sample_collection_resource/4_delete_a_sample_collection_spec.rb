...
describe "delete_a_sample_collection", :sample_collection => true do
  include_context "use core context service"
  it "delete_a_sample_collection" do
    ...
    save_with_uuid collection => [1,2,3,4,5], sample => [1,2,3,4,6], sample2 => [1,2,3,4,7]
