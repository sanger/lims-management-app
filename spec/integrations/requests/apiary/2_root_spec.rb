...
describe "root" do
  ...
  # Support App can be performed browsing this JSON response.
    ...
    "bulk_create_samples": {
        "actions": {
            "create": "http://example.org/actions/bulk_create_samples"
        }
    },
    "update_samples": {
        "actions": {
    ...
    "bulk_delete_samples": {
        "actions": {
            "create": "http://example.org/actions/bulk_delete_samples"
        }
    },
    "create_samples": {
        "actions": {
    ...
    "bulk_update_samples": {
        "actions": {
            "create": "http://example.org/actions/bulk_update_samples"
        }
    },
    "revision": 3
}
