...
describe "bulk_update_sample_with_sanger_sample_id_by_sanger_sample_id", :sample => true do
  include_context "use core context service"
  include_context "timecop"
  it "bulk_update_sample_with_sanger_sample_id_by_sanger_sample_id" do
