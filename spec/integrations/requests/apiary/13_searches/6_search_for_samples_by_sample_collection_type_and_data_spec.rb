...
describe "search_for_samples_by_sample_collection_type_and_data", :searches => true do
  include_context "use core context service"
  it "search_for_samples_by_sample_collection_type_and_data" do
    ...
    collection2 = Lims::ManagementApp::SampleCollection.new({
      ...
      :data => [
          ...
          Lims::ManagementApp::SampleCollection::SampleCollectionData::Bool.new(:key => "key_bool2", "value" => true),
    ...
    collection3 = Lims::ManagementApp::SampleCollection.new({
      ...
      :data => [
          ...
          Lims::ManagementApp::SampleCollection::SampleCollectionData::Url.new(:key => "key_url", "value" => "http://www.sanger.ac.uk"),
          Lims::ManagementApp::SampleCollection::SampleCollectionData::Int.new(:key => "key_int", "value" => 245),
          Lims::ManagementApp::SampleCollection::SampleCollectionData::Int.new(:key => "key_int2", "value" => 789)
      ],
    ...
    {
    "search": {
        "description": "search for samples by collection data and type",
        "model": "sample",
        "criteria": {
            "sample_collection": {
                "type": "User",
