...
describe "search_for_sample_collections_by_sample_uuids", :searches => true do
  include_context "use core context service"
  it "search_for_sample_collections_by_sample_uuids" do
    ...
    {
    "search": {
        "description": "search for sample collections by sample uuids",
