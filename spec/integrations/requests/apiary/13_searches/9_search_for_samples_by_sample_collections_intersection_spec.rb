...
describe "search_for_samples_by_sample_collections_intersection", :searches => true do
  include_context "use core context service"
  it "search_for_samples_by_sample_collections_intersection" do
    ...
    collection3 = Lims::ManagementApp::SampleCollection.new({
      ...
      :data => [
          ...
          Lims::ManagementApp::SampleCollection::SampleCollectionData::DataInt.new(:key => "key_int", "value" => 300)
      ],
    ...
    {
    "search": {
        "description": "search for samples by collection uuids intersection",
        "model": "sample",
        "criteria": {
            "sample_collection": {
                "uuids_intersection": [
