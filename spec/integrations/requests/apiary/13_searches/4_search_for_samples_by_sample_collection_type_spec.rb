...
describe "search_for_samples_by_sample_collection_type", :searches => true do
  include_context "use core context service"
  it "search_for_samples_by_sample_collection_type" do
    ...
    {
    "search": {
        "description": "search for samples by collection type",
        "model": "sample",
        "criteria": {
            "sample_collection": {
                "type": "Study"
